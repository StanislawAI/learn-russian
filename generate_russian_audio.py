...
phrases = [
    ...
    {"text": "Помогите!", "translation": "Help!", "topic": "Emergency"},
    {"text": "Вызовите скорую помощь!", "translation": "Call an ambulance!", "topic": "Emergency"},
    {"text": "У меня болит сердце.", "translation": "I have chest pain.", "topic": "Emergency"},
    {"text": "Где ближайшая больница?", "translation": "Where is the nearest hospital?", "topic": "Emergency"},
    {"text": "Я потерял паспорт.", "translation": "I lost my passport.", "topic": "Emergency"},
    {"text": "Мне нужно в полицию.", "translation": "I need to go to the police.", "topic": "Emergency"},
    {"text": "Это срочно!", "translation": "This is urgent!", "topic": "Emergency"}
